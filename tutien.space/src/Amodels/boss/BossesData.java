...
public class BossesData {
    ...
    public static final BossData KUKU = new BossData(
            ...
            35000, //dame
            new long[]{Util.nextInt(7300000, 9000000)}, //hp
    ...
    public static final BossData MAP_DAU_DINH = new BossData(
            ...
            40000, //dame
            new long[]{Util.nextInt(15000000, 20000000)}, //hp
    ...
    public static final BossData RAMBO = new BossData(
            ...
            45000, //dame
            new long[]{Util.nextInt(20000000, 30000000)}, //hp
...
//**************************************************************************
    ...
    public static final BossData CUMBER = new BossData(
        ...
        public static final BossData SONGOKU_TA_AC = new BossData(
            ...
            new int[][]{
                    ...
                    {Skill.DICH_CHUYEN_TUC_THOI, 3, 90000},
                    {Skill.KAMEJOKO, 7, 10000},
    ...
    public static final BossData XEN_BO_HUNG_1 = new BossData(
            ...
            new String[]{"|-2|Khốn kiếp, cccc.. hắn bị Cell hấp thu rồi!!"}, //text chat 3
            REST_30_M
    );
    ...
    public static final BossData SIEU_BO_HUNG_1 = new BossData(
            ...
            new int[][]{
                   {Skill.LIEN_HOAN, 7, 10000},
                    ...
                    {Skill.TAI_TAO_NANG_LUONG, 7, 3000000},
                    {Skill.LIEN_HOAN, 7, 1000},
                    {Skill.THAI_DUONG_HA_SAN, 7, 100000}},
            //skill
    ...
    public static final BossData SUPER_BLACK_GOKU = new BossData(
            ...
            new int[][]{
                 {Skill.THAI_DUONG_HA_SAN, 7, 30000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 7, 3000000},
                    {Skill.KAMEJOKO, 7, 10000},
                    {Skill.LIEN_HOAN, 7, 10000}},
            //skill
            new String[]{}, //text chat 1
...
//            new int[]{14}, //map join
    ...
    public static final BossData THANZM2 = new BossData(
            ...
            new int[][]{
                    ...
                    {Skill.TAI_TAO_NANG_LUONG, 1, 3000000},
...
//                    {Skill.KHIEN_NANG_LUONG, 7, 50000},
            ...
            new int[][]{
                {Skill.DICH_CHUYEN_TUC_THOI, 7, 100000},
                   {Skill.DE_TRUNG, 7, 1000},
                    ...
                    {Skill.MASENKO, 2, 3000},},//skill//skill
            new String[]{}, //text chat 1
    ...
    public static final BossData COOLER_2 = new BossData(
            ...
            new int[][]{
                ...
                {Skill.KHIEN_NANG_LUONG, 7, 100000},
                    ...
                    {Skill.LIEN_HOAN, 2, 3000},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Các ngươi thật là yếu ớt",
    ...
    public static final BossData Corona_1 = new BossData(
            "Hỏa Long Chí Tôn", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1318, 1319, 1320, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new long[]{300000000000000L}, //hp
            new int[]{6,27,28,29,30,13,31,32,33,34,10,19,20,35,36,37,38}, //map join
            new int[][]{
                    {Skill.LIEN_HOAN, 1, 3000},
//                     {Skill.KHIEN_NANG_LUONG, 7, 100000},
                    {Skill.KAMEJOKO, 5, 400},},
                
            new String[]{}, //text chat 1
            new String[]{"|-1|Đòi Lấy Tu VI?",
                    "|-1|Ta sẽ phá hủy tế bào phổi của các ngươi",
                    "|-1|Chán quá!",
                    "|-1|Không dám cưỡi khẩu trang đấu với ta sao?",
                    "|-1|Ta nghèo lắm!Đừng săn ta nữa",}, //text chat 2
            new String[]{"|-1|Lấy Tu Vi Của TA không dễ ĐÂu"}, //text chat 3
            REST_30_M
    );
    public static final BossData Corona_2 = new BossData(
            "Băng Long Chí Tôn", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1313, 1314, 1315, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            100000000, //dame
             new long[]{300000000000000L}, //hp
             new int[]{6,27,28,29,30,13,31,32,33,34,10,19,20,35,36,37,38}, //map join
            new int[][]{
                {Skill.LIEN_HOAN, 1, 3000},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Các ngươi thật là yếu ớt",
                    "|-1|Ta sẽ phá hủy tế bào phổi của các ngươi",
                    "|-1|Chán quá!",
    ...
    public static final BossData Corona_3 = new BossData(
             "Hỏa Long Chí Tôn", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1318, 1319, 1320, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000000, //dame
             new long[]{300000000000000L}, //hp
            new int[]{198,196,197}, //map join
            new int[][]{
    ...
    public static final BossData Corona_4 = new BossData(
           "Băng Long Chí Tôn", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1313, 1314, 1315, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000000, //dame
             new long[]{3000000000000000L}, //hp
              new int[]{6,27,28,29,30,13,31,32,33,34,10,19,20,35,36,37,38}, //map join
            new int[][]{
                {Skill.LIEN_HOAN, 7, 3000},},//skill//skill
            new String[]{}, //text chat 1
    ...
    public static final BossData Anime_1 = new BossData(
            "Thiên sứ Whis", //name
          ...
          new long[]{100}, //hp
            ...
            new int[][]{
                    ...
                    {Skill.TAI_TAO_NANG_LUONG, 3, 100000},},//skill//skill
    ...
    public static final BossData Anime_2 = new BossData(
    ...
    public static final BossData Anime_3 = new BossData(
            "Thiên sứ Vados", //name
            ConstPlayer.NAMEC, //gender
    ...
    public static final BossData Anime_4 = new BossData(
...
//            new int[]{14},
    ...
    public static final BossData Saibamen = new BossData(
        ...
        //**************************************************************************Team Mabu 12h
    public static final BossData MA_22H = new BossData(
            "Tàu Pảy Pảy",
            ConstPlayer.XAYDA,
       ...
       public static final BossData thantai = new BossData(
            "Thần Tài", //lion
            ConstPlayer.XAYDA, //gender
            new short[]{1651, 1652, 1653, 61, 37, 37}, //outfit {head, body, leg, bag, aura, eff}
            200000, //dame
            ...
            new String[]{
                    "|-1|phát vàng,phát vàng đây!",
                    "|-2|Tới đây mà lấy đi nào haha!"
            }, //text chat 1
            new String[]{"|-1|Các ngươi sướng lắm mới gặp phải ta",
                    "|-1|Vàng đây vàng đây",
                    "|-2|iu..vàng..bạc..châu báu của ta!!",
                    "|-2|Không\",\n" +
"                    \"|-2|thôi ta sẽ thưởng cho cắc ngươi ..!!"
            }, //text chat 2
            new String[]{"|-1|haha!!!"}, //text chat 3
    ...
    public static final BossData THAN_HUY_DIET = new BossData(
            ...
            new short[]{508, 509, 510, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            2000000, //dame
            new long[]{10000000000000000L}, //hp
            new int[]{209}, //map join
            new int[][]{
//                    {Skill.MASENKO, 7, 200},
                    {Skill.LIEN_HOAN, 7, 300},
                    {Skill.TAI_TAO_NANG_LUONG, 7, 100000}},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Các ngươi thật là yếu ớt",
                    "|-1|Ta sẽ phá hủy hành tinh này",
                    "|-1|Chán quá!",
