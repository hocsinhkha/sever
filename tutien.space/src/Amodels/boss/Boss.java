...
import static Amodels.boss.BossStatus.CHAT_E;
import static Amodels.boss.BossStatus.CHAT_S;
import static Amodels.boss.BossStatus.DIE;
import static Amodels.boss.BossStatus.JOIN_MAP;
import static Amodels.boss.BossStatus.LEAVE_MAP;
import static Amodels.boss.BossStatus.RESPAWN;
import static Amodels.boss.BossStatus.REST;
import tutien.models.boss.iboss.IBossNew;
import tutien.models.boss.iboss.IBossOutfit;
...
//        }
    ...
    protected void notifyJoinMap() {
        ...
        if (this.zone.map.mapId == 140||MapService.gI().isMapMaBu(this.zone.map.mapId) ||MapService.gI().isMapGiaiCuuMiNuong(this.zone.map.mapId) || MapService.gI().isMapBlackBallWar(this.zone.map.mapId))
            return;
