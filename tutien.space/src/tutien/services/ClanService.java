...
import static tutien.models.clan.Clan.DEPUTY;
import static tutien.models.clan.Clan.LEADER;
import static tutien.models.clan.Clan.MEMBER;
import tutien.models.item.Item;
import barcoll.consts.ConstNpc;
import barcoll.models.Template.FlagBag;
import tutien.models.clan.Clan;
import tutien.models.clan.ClanMember;
import tutien.models.clan.ClanMessage;
    ...
    public void kickOut(Player player, int memberId) {
        ...
        if (clan != null && cm != null
            ...
            if (plKicked != null) {
                ...
                ItemTimeService.gI().removeTextGiaiCuuMiNuong(plKicked);
            } else {
