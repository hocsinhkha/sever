...
import barcoll.models.Template.ItemLuckyRound;
import barcoll.models.Template.ItemOptionLuckyRound;
...
public class RewardService {
    ...
    private static final int[][][] ACTIVATION_SET = {
        ...
        {{135, 138, 1, 1000}, {133, 136, 1, 1000}, {134, 137, 1, 1000}, {239, 238, 1, 1000}} //kakarot - cadic - nappa
    };
            ...
            case 0: //áo
                ...
                switch (tempId) {
                    ...
                    case 555: //áo thần trái đất
                        ...
                        option_param[0][1] = Util.nextInt(500, 800);
                        option_param[2][1] = 15;
                        break;
                    ...
                    case 650: //áo thần trái đất
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(1000, 1200);
                        option_param[2][1] = 50;
                        break;
                    ...
                    case 654: //áo thần xayda
                        ...
                        option_param[2][1] = 50;
                        break; 
                        case 1048: //áo thần trái đất
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(1700, 1900);
                        option_param[2][1] = 80;
                        break;
                    case 1049: //áo thần namếc
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(1700, 1900);
                        option_param[2][1] = 80;
                        break;
                    case 1050: //áo thần xayda
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(1700, 1900);
                        option_param[2][1] = 80;
                        break; 
            ...
            case 1: //quần
                ...
                switch (tempId) {
                    ...
                    case 556: //quần thần trái đất
                        ...
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(50, 70);
                        option_param[1][1] = Util.nextInt(10000, 12000);
                        option_param[2][1] = 15;
                        break;
                    ...
                    case 651: //quần thần trái đất
                        option_param[0][0] = 22; //hp
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(90, 120);
                        option_param[1][1] = Util.nextInt(15000, 20000);
                        option_param[2][1] = 50;
                        break;
                    ...
                    case 655: //quần thần xayda
                        ...
                        option_param[2][1] = 50;
                        break;
                        case 1051: //quần thần trái đất
                        option_param[0][0] = 22; //hp
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(130, 170);
                        option_param[1][1] = Util.nextInt(25000, 40000);
                        option_param[2][1] = 80;
                        break;
                    case 1052: //quần thần namếc
                        option_param[0][0] = 22; //hp
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(130, 170);
                        option_param[1][1] = Util.nextInt(25000, 40000);
            ...
            case 2: //găng
                ...
                switch (tempId) {
                    ...
                    case 562: //găng thần trái đất
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(2500, 3500);
                        option_param[2][1] = 17;
                        break;
                    ...
                    case 657: //găng thần trái đất
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(9000, 11000);
                        option_param[2][1] = 50;
                        break;
                    ...
                    case 661: //găng thần xayda
                        ...
                        option_param[2][1] = 50;
                        break;    
                    case 1054: //găng thần trái đất
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(10000, 15000);
                        option_param[2][1] = 80;
                        break;
                    case 1055: //găng thần namếc
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(10000, 15000);
                        option_param[2][1] = 80;
                        break;
                    case 1056: //găng thần xayda
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(10000, 15000);
                        option_param[2][1] = 80;
                        break;        
            ...
            case 3: //giày
                ...
                switch (tempId) {
                    ...
                    case 563: //giày thần trái đất
                        option_param[0][0] = 23;
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(40, 80);
                        option_param[1][1] = Util.nextInt(10000, 30000);
                        option_param[2][1] = 14;
                        break;
                    ...
                    case 567: //giày thần xayda
                        option_param[0][0] = 23;
                        option_param[2][0] = 21; //yêu cầu sức
                        option_param[0][1] = Util.nextInt(40, 80);
                        option_param[1][1] = Util.nextInt(10000, 30000);
                        option_param[2][1] = 14;
                        break;
                    ...
                    case 658: //giày thần trái đất
                        option_param[0][0] = 23;
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(80, 110);
                        option_param[1][1] = Util.nextInt(30000, 60000);
                        option_param[2][1] = 36;
                        break;
                    ...
                    case 662: //giày thần xayda
                        ...
                        option_param[2][1] = 36;
                        break;
                        case 1057: //giày thần trái đất
                        option_param[0][0] = 23;
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(100, 180);
                        option_param[1][1] = Util.nextInt(30000, 100000);
                        option_param[2][1] = 36;
                        break;
                    case 1058: //giày thần namếc
                        option_param[0][0] = 23;
                        option_param[2][0] = 21; //yêu cầu sức mạnh
                        option_param[0][1] = Util.nextInt(100, 180);
                        option_param[1][1] = Util.nextInt(30000, 100000);
            ...
            case 4: //rada
                ...
                switch (tempId) {
                    ...
                    case 561: //nhẫn thần linh
                        ...
                        option_param[0][1] = Util.nextInt(14, 18);
                        option_param[2][1] = 21;
                        break;
                    case 656: //nhẫn thần linh
                        option_param[2][0] = 21; //yêu cầu sức mạnh

                        option_param[0][1] = Util.nextInt(14, 22);
                        option_param[2][1] = 50;
                        break;
                        case 1060: //nhẫn thần linh
                        option_param[2][0] = 21; //yêu cầu sức mạnh

                        option_param[0][1] = Util.nextInt(14, 25);
                        option_param[2][1] = 80;
                        break;
                        case 1061: //nhẫn thần linh
                        option_param[2][0] = 21; //yêu cầu sức mạnh

                        option_param[0][1] = Util.nextInt(14, 25);
                        option_param[2][1] = 80;
                        break;
                        case 1062: //nhẫn thần linh
                        option_param[2][0] = 21; //yêu cầu sức mạnh

                        option_param[0][1] = Util.nextInt(14, 25);
                        option_param[2][1] = 80;
                        break;
                        case 1981: //nhẫn thần linh
                        option_param[2][0] = 21; //yêu cầu sức mạnh
