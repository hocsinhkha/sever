...
public class Trade {
    ...
    public void addItemTrade(Player pl, byte index, int quantity) {
        ...
        if (true) {
           ...
           this.cancelTrade();
//              if (pl.nPoint.power < 100000000000L) {
//            Service.gI().sendThongBao(pl, "Yêu cầu sức mạnh lớn hơn 100 tỷ");
//  
    ...
    private boolean isItemCannotTran(Item item) {
        ...
        if(item.template.id == 454 ||item.template.id == 1389 ||item.template.id == 2064 ||item.template.id == 1386 ||item.template.id == 1387 ||item.template.id == 1388 ){
            return true;
        }
        switch (item.template.type) {
            
            case 27: //
                if (item.template.id == 590 || item.template.id == 1832 || item.template.id == 1831 || item.template.id == 1830 || item.template.id == 1829 || item.template.id == 1129 || item.template.id == 921 || item.template.id == 1132) {
                    return true;
                }
                else if (item.template.id == 457 || item.template.id == 1450 || item.template.id == 1066 || item.template.id == 1067 || item.template.id == 1068 || item.template.id == 1069 || item.template.id == 1070
