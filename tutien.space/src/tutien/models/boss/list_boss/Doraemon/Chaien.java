package tutien.models.boss.list_boss.Doraemon;
...
public class Chaien extends Boss {
   ...
   public void reward(Player plKill) {
        {
            if (plKill != null) {
                plKill.Tamkjlltutien[0] += 500000;
                plKill.ExpTamkjll += 10000000;
                Service.gI().sendMoney(plKill);
                 Service.getInstance().dropItemMap(this.zone, Util.ratiItem(zone, 2025, 1, this.location.x + 70, this.location.y, plKill.id));
                 ...
                 Service.getInstance().dropItemMap(this.zone, Util.ratiItem(zone, 2025, 1, this.location.x - 100, this.location.y, plKill.id));
                 Service.getInstance().dropItemMap(this.zone, Util.ratiItem(zone, 2025, 1, this.location.x - 59, this.location.y, plKill.id));
                 Service.getInstance().dropItemMap(this.zone, Util.ratiItem(zone, 2025, 2, this.location.x - 55, this.location.y, plKill.id));
                 ...
                 Service.getInstance().dropItemMap(this.zone, Util.ratiItem(zone, 2025, 2, this.location.x - 25, this.location.y, plKill.id));
                 Service.getInstance().dropItemMap(this.zone, Util.ratiItem(zone, 2025, 1, this.location.x - 21, this.location.y, plKill.id));
                 Service.gI().sendThongBao(plKill, "Bạn nhận đc 500k Tu Tiên và 10 Triệu Tu Vi do kết liễu boss.");
