...
import tutien.models.matches.pvp.TraThu;
import tutien.models.matches.pvp.ThachDau;
...
public class PVPService {
    ...
    public void sendInvitePVP(Player pl, byte selectGold) {
        ...
        if (plMap.getSession().active) {
            Service.getInstance().sendThongBao(pl, "Đối thủ chưa là thành viên của MASEW");
            return;
        }
